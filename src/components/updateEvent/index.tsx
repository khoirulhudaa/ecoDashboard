...
import { useEventUpdateFormik } from '../Validation/useUpdateEventFormik';
...
const UpdateEvent: React.FC = () => {
    ...
    const eventFormik = useEventUpdateFormik({
        ...
        <div className="flex flex-col gap-5.5 p-6.5">
            ...
            <form>
                <div className='w-full flex-col flex justify-between items-center'>
                    ...
                    <div className='w-full mb-5'>
                        ...
                        <CKEditor
                            ...
                            data={eventFormik.values.content}
                ...
                <div className='w-max flex items-center'>
                    ...
                    {
                        eventFormik.values.name_event !== '' && eventFormik.values.description !== '' && eventFormik.values.content !== '' ? (
