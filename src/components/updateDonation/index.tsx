...
import { useDonationUpdateFormik } from '../Validation/useUpdateDonationFormik';

const UpdateDonation: React.FC = () => {
    ...
    const handleResponseDonation = () => {
        setError('')
        SweetAlert({
            title: 'Berhasil perbarui donasi!',
    ...
    const donationFormik = useDonationUpdateFormik({
        onError: handleErrorMessage,
        onResponse: handleResponseDonation,
        ...
        <div className="flex flex-col gap-5.5 p-6.5">
            ...
            <form>
                <div className='w-full flex-col flex justify-between items-center'>
                    ...
                    <div className='w-full mb-5'>
                        ...
                        <CKEditor
                            ...
                            data={donationFormik.values.content}
                ...
                <div className='w-full flex justify-between items-center'>
                    <div className='mb-5 w-full'>
                        <label className="mb-3 block text-sm font-medium text-black dark:text-white">
                            Thumbnail (Kosongkan jika tidak diperbarui)
                        </label>
                        <input
                            type="file"
                            name='thumbnail'
                            ...
                            onBlur={donationFormik.handleBlur}
                            placeholder="'Masukan Photo (opsional)"
                            className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                        />
                    </div>
                </div>
                ...
                <div className='w-max flex items-center'>
                    ...
                    {
                        donationFormik.values.name_donation !== '' && donationFormik.values.description !== '' && donationFormik.values.content !== '' ? (
